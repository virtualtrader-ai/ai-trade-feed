...
profiles = {from openai import OpenAI
import json
import os
from datetime import date
import time
...
profiles = {
    ...
    "person_f": {"name": "Bob - The Political Figure Trader", "prompt_overlay": "Focus strictly on trades disclosed by U.S. politicians like Nancy Pelosi. Always state the politician's name and link to disclosure source."}
}
...
# Market Pulse generation remains the same as before (can reuse your last version)
